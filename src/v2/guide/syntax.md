...
<p class="tip">Вирази в шаблонах ізольовані і лише можуть мати доступ до [чітко визначеного списку глобальних змінних](https://github.com/vuejs/vue/blob/v2.6.10/src/core/instance/proxy.js#L9), таких як `Math` та `Date`. Не намагайтеся звернутися до глобальних змінних у виразах в шаблоні.</p>
