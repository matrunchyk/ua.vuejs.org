...
Зауважте, що в цьому методі ми оновлюємо стан нашого застосунку, не зачіпаючи DOM - всі маніпуляції з ним виконуються через Vue, та при написанні коду ви зосереджені лише на логіку в основі.
